...
namespace GeneralTool.General.TaskExtensions
{
    ...
    public static class DelegateExtensions
    {
        ...
        /// <param name="handler">执行的任务</param>
        /// <param name="reTryCount">重试次数</param>
        /// <param name="paramters">任务参数列表</param>
        /// <returns>返回指定类型的数据</returns>
        /// <exception cref="ArgumentException"></exception>
        /// <exception cref="TypeNotEqualsException"></exception>
        ...
        /// <list type="bullet">
        /// <item>通过<see cref="DelegateExtensions.GetLastErroMsg()"/>获取最后返回的错误信息(如果有)</item>
        /// <item>或者使用<see cref="DelegateExtensions.RetryResultAsync{T}(Delegate, TimeSpan, int, object[])"/></item>
        /// </list>
        /// </summary>
        /// <typeparam name="T">返回的参数类型</typeparam>
        /// <param name="handler">执行的任务</param>
