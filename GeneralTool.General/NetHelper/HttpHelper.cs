...
namespace GeneralTool.General.NetHelper
{
    ...
    public class HttpHelper
    {
        ...
        /// 添加Cookie
        /// </summary>
        /// <param name="name"> System.Net.Cookie 的名称。 不能在 name 中使用下列字符：等号、分号、逗号、换行符 (\n)、回车符 (\r)、制表符 (\t) 和空格字符 ，货币符号 ($) 不能作为第一个字符。</param>
        /// <param name="value">System.Net.Cookie 的值。 下列字符不得用在 value 中：分号、逗号。</param>
        /// <param name="path">此 System.Net.Cookie 适用于的源服务器上的 URI 的子集。 默认值为“/”。</param>
