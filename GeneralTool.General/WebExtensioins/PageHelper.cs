...
namespace GeneralTool.General.WebExtensioins
{
    ...
    public static class PageHelper
    {
        ...
        /// <param name="pageSum">所有页码数量</param>
        ...
        /// </summary>
        /// <param name="pageIndex">当前页码</param>
        /// <param name="dataCount">当前数据总条数</param>
        /// <param name="pageSize">每页数量条数</param>
        /// <param name="pageCount">要生成的页码数量</param>
        /// <returns>第一页的页码,最后一页的页码</returns>
        ...
        /// <summary>
        /// 根据每页条数及当前页码计算偏移起始值,
        /// 在Mysql或Pgsql中使用例:SELECT * FROM TEST LIMIT {pageSize} OFFSET PageOffset(pageSize,1)
        /// </summary>
