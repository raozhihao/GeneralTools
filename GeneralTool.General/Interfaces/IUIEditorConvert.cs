...
namespace GeneralTool.General.Interfaces
{
    ...
    public interface IUIEditorConvert
    {
        ...
        /// </summary>
        /// <param name="gridParent">上级Grid控件</param>
        /// <param name="instance">需要编辑的对象</param>
        /// <param name="propertyInfo">当前属性</param>
        /// <param name="sortAsc">排序方式</param>
        /// <param name="Row">当前应该处于上级Grid控件中的行号</param>
        /// <param name="header">可选的添加Header</param>
