...
namespace GeneralTool.CoreLibrary.AuboSixAxisMechanicalArm
{
    partial class RobotAdepter
    {
        ...
        public static extern int rs_login(UInt16 rshd, [MarshalAs(UnmanagedType.LPWStr)] string addr, int port);
        ...
        /// <returns></returns>
        [DllImport(Robot_Library, EntryPoint = "rs_set_tool_do_status", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.Cdecl)]
        ...
        /// <returns></returns>
        [DllImport(Robot_Library, EntryPoint = "rs_get_tool_io_status", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.Cdecl)]
